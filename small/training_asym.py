...
def RunExp(args, dataset, data, Net, percls_trn, val_lb):
    ...
    print(f'avg 50 loss:')
    # for i in range(5):
    #     print(f'{torch.mean(torch.tensor( train_loss_history[i:(i+1) * 100]) ) }')

    print(f'{train_loss_history[0:20]}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, choices=['Cora','Citeseer','Pubmed','Chameleon','Squirrel','Actor','Texas','Cornell', 'Wisconsin'],default='Cora')
